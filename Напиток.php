...
<div id="qn1">Какой напиток вам больше нравиться?</div>
...
<form method='POST' action='спс.php' >
 <div id="ques"><input type="radio" name="ff1" value='1'><div id="q1" style="font-size: 20px">Чай</div>
<br></div><div id="ques"><input type="radio" name="ff1" value='2'><div id="q1" style="font-size: 20px">Кола</div>
<br></div><div id="ques"><input type="radio" name="ff1" value='3'><div id="q1" style="font-size: 20px">Кофе</div>
<br></div><div id="ques"><input type="radio" name="ff1" value='4'><div id="q1" style="font-size: 20px">Пепси</div>
<br></div><div id="ques"><input type="radio" name="ff1" value='5'><div id="q1" style="font-size: 20px">Фанта</div>
<br></div>
